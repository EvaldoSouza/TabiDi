...
class EditorMostrarJogadoresCampeonato(tk.Toplevel): 
    def __init__(self, db_path, root):
        ...
        #self.lista_users = self.controller.todos_jogadores_do_campeonato(self)
    ...
    def atualizar(self):
        self.lista_users = self.controller.todos_jogadores_do_campeonato()
        self.construir_tabela(self.lista_users)